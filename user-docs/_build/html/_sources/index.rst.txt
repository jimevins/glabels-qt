...
.. |title-image| image::  manual/figures/intro-glabels-label-designer.png
   :align:   bottom
...
.. note:: In the following chapters many screenshots from gLabels will be shown.  As gLabels runs on many different platforms with many different window managers and themes applied, your screen might look different from these screenshots.  As there will be no real differences in functionality of gLabels between environments, these screenshots should still be understandable.
